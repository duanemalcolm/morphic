...
class TestBasisFunction(unittest.TestCase):
    ...
    def test_T33d1(self):
        x = numpy.array([[0.13, 0.23], [0.77, 0.06]])
        numpy.testing.assert_almost_equal(interpolator.T33d1(x),
            array([[-0.7696 ,  0.9882 , -0.27675,  0.05815, -2.9394 , 
                    3.1671 , -0.2277 ,  0.32085, -0.32085,  0.     ],
                    [ 0.13985, -0.44415, -1.76985,  2.07415, -0.0054 ,
                    -0.972  , 0.9774 ,  0.2214 , -0.2214 ,  0.     ]]))
                     
    def test_T33d2(self):
        x = numpy.array([[0.13, 0.23], [0.77, 0.06]])
        numpy.testing.assert_almost_equal(interpolator.T33d2(x),
            array([[-0.7696 , -1.6614 ,  0.35685,  0.     , -0.2898 ,
                1.4391 , -0.35685,  1.41525,  0.2223 , -0.35585],
                [ 0.13985, -0.0693 , -4.53915,  0.     , -0.38025,  2.2869 ,
                4.53915, -0.2682 , -2.2176 ,  0.5086 ]]))
